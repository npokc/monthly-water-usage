...
public class UserService implements UserDetailsService {
	...
	protected void initialize() {
		...
		accountService.save(new Account("apartment13", "apartment13", "ROLE_ADMIN"));
		...
		accountService.save(new Account("apartment22", "apartment22", "ROLE_ADMIN"));
		accountService.save(new Account("apartment23", "apartment23", "ROLE_ADMIN"));
